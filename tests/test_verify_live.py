...
class LiveVerifierTests(unittest.TestCase):
    ...
    def test_missing_share_asset_fails_verification(self):
        # The raster social share card is staged and middleware-allowed, but a
        # deploy that drops it again must fail loudly instead of passing as
        # verified. The SVG design source is expected to 404, never to serve.
