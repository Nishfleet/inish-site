...
{cards}
  ...
  <footer>
    <div class="footer-links"><a href="/feed.xml">RSS</a><a href="/latest.json">JSON</a><a href="/about.html">About</a><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a><a href="/contact.html">Contact</a></div>
...
def sitemap(date: str) -> str:
    body = f'<url><loc>https://inish.in/</loc><lastmod>{date}</lastmod></url><url><loc>https://inish.in/about.html</loc><lastmod>{date}</lastmod></url><url><loc>https://inish.in/privacy.html</loc><lastmod>{date}</lastmod></url><url><loc>https://inish.in/terms.html</loc><lastmod>{date}</lastmod></url><url><loc>https://inish.in/contact.html</loc><lastmod>{date}</lastmod></url>'
