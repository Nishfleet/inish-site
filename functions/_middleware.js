...
//
// The decision lives in ./policy.js (which imports public-paths.json) so the
// deny/allow/redirect branch can be exercised by real tests against the
// imported function rather than by substring matching on this file.
import { canonicalize, decide, redirects, hstsHeader } from "./policy.js";
